 ...
 */
public class fragment_reg_bus_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fragment_reg_bus_2, container, false);
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener((Register) view.getContext(), new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    ((Register)getActivity()).addBusRegister(user.getUid());
                }else{
